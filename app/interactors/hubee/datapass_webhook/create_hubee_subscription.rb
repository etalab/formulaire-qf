class DatapassWebhook::CreateHubEESubscription < BaseInteractor
  delegate :hubee_organization_payload, :hubee_subscription_payload, :service_provider, to: :context
  ...
  def create_subscription_on_hubee
    hubee_api_client.create_subscription(hubee_organization_payload, process_code, editor_payload)
  end
